...
assert(grade.includes('score-core-v8-5-14-criterion-differentiation-3-to-7-v4-4'), 'grade-ielts.js should identify v4.4 neutral AI-primary cleanup');
assert(router.includes('production-router-v3-5-criterion-differentiation-routing-v4-4'), 'router should identify v4.4 neutral AI-primary routing');
...
console.log('PASS midband AI-primary v4.4 static test');
