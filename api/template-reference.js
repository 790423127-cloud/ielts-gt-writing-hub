...
function buildFinalGrammarPolishPrompt(body, spec, templateId, referenceEssay) {
  return [
    ...
    "Keep sentences short and accurate. Use 2-4 safe grammar patterns with because, when, if, although, or which, but only when the grammar is safe.",
    "If grammar is too simple, add a small grammar word or combine two short ideas with because/when/if/which. Do not add a new idea just to make the answer longer.",
